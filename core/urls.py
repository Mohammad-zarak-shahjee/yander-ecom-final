...
urlpatterns = [
    ...
    path ('signup/',random_sign,name='signup'),  #signup url
    ...
    #path('order-confirmed/',OrderConfirmedView, name='OrderConfirmed'),
    path('activate/<uidb64>/<token>/',activate, name='activate'),  #naya email verify url
    #path('verified_email_required/',random_sign,name='verify'),
