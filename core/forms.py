...
class RefundForm(forms.Form):
    ...
    email =forms.EmailField(help_text='Enter a Email address comprising of letters,numbers,underscore & periods')
...
class MyCustomSignupForm(UserCreationForm):  
    ...
    email = forms.EmailField(max_length=254, help_text='Enter a Email address comprising of letters,numbers,underscore & periods')
